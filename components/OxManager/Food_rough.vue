        ...
        <v-card>
            ...
            <v-card-text>
                <form @submit.prevent="(form.id)?updateData():saveData()"> 
                    ...
                    <v-text-field required label="อาหารหยาบ (กก./ตัว/วัน)" v-model="form.food" prepend-inner-icon="mdi-rice" />
                    <v-text-field required label="ชนิดของอาหารหยาบ" v-model="form.food_type" prepend-inner-icon="mdi-tag" />  
