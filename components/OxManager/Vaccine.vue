        ...
        <v-card-text v-if="dialog">
          <form @submit.prevent="(form.id)?updateData():saveData()">
            ...
            <v-select    :items="choices.maker" item-text="name" item-value="id" label="maker_id" v-model="form.maker"  />
              ...
              <v-text-field v-if="form.maker == 3"   label="vaccine_ect" v-model="form.maker_ect"  />

            <v-select   :items="choices.items" item-text="name" item-value="id" label="vaccine_id" v-model="form.vaccine"  />

              <v-text-field v-if="form.vaccine == 4" label="vaccine_ect" v-model="form.vaccine_ect"  />
